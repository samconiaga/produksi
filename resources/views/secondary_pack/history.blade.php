    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
          <div>
            ...
            <p class="mb-0 text-muted">
              ...
              proses <strong>Secondary Pack</strong>.
            </p>
          </div>
          ...
          <div>
            <a href="{{ route('secondary-pack.index') }}"
              ...
              &laquo; Kembali ke Secondary Pack
            </a>
          </div>
        </div>
        ...
        <div class="card-body border-bottom">
          <form class="row g-1" method="GET" action="{{ route('secondary-pack.history') }}">
            <div class="col-md-3">
              <input type="text"
                     name="q"
                     value="{{ $q }}"
            ...
            @empty
              <tr>
                <td colspan="9" class="text-center text-muted">
                  Belum ada riwayat Secondary Pack.
                </td>
              </tr>
            @endforelse
            </tbody>
