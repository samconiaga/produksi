...
<head>
  ...
  @php
    ...
    // === POSISI TEKS (bisa tuning via query) ===
    // kolom label, titik dua, value
    ...
    $hdrCenterMm = (float) request('hc',  $hdrCenterMm ?? 38); // posisi "PELULUSAN..." (tengah-ish)
  ...
  <style>
    ...
    .card{
      ...
      overflow: visible; /* jangan hidden biar gak kepotong */
    }
    ...
    .hdr-mid .t1{ display:block; }
    .hdr-mid .t2{ display:block; }
