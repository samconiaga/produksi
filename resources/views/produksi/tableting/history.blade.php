    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a href="{{ route('tableting.index') }}" class="btn btn-sm btn-outline-secondary">
            &laquo; Kembali ke Tableting
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          {{-- Filter --}}
          <form method="GET" action="{{ route('tableting.history') }}" class="row g-2 mb-3">
            <div class="col-md-4">
              <input type="text"
                     name="q"
                     class="form-control"
