        ...
        <div class="card-header d-flex justify-content-between align-items-center">
          <div>
            ...
            <p class="mb-0 text-muted">
              Menampilkan batch yang <strong>sudah Release Tablet</strong>.
              Data di sini bersifat historis (read-only).
            </p>
          </div>

          <a href="{{ route('qc-tablet.index') }}"
            ...
            @forelse($batches as $idx => $batch)
              <tr>
                ...
                <td class="text-center">
                  {{ $batch->tgl_datang_tablet
                        ? $batch->tgl_datang_tablet->format('d-m-Y')
                        : '-' }}
                </td>
                <td class="text-center">
            ...
            @empty
              <tr>
                <td colspan="11" class="text-center text-muted">
                  Belum ada riwayat Produk Antara Tablet.
                </td>
              </tr>
            @endforelse
            </tbody>
